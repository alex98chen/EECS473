...
C_SRCS += \
../bluetooth/host/host/config/ble_globals.c 

OBJS += \
./bluetooth/host/host/config/ble_globals.o 

C_DEPS += \
./bluetooth/host/host/config/ble_globals.d 


# Each subdirectory must supply rules for building sources it contributes
bluetooth/host/host/config/%.o: ../bluetooth/host/host/config/%.c
	@echo 'Building file: $<'
