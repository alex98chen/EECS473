...
C_SRCS += \
../bluetooth/profiles/led/led_service.c 

OBJS += \
./bluetooth/profiles/led/led_service.o 

C_DEPS += \
./bluetooth/profiles/led/led_service.d 


# Each subdirectory must supply rules for building sources it contributes
bluetooth/profiles/led/%.o: ../bluetooth/profiles/led/%.c
	@echo 'Building file: $<'
