...
C_SRCS += \
../framework/framework/MWSCoexistence/Source/MWS.c 

OBJS += \
./framework/framework/MWSCoexistence/Source/MWS.o 

C_DEPS += \
./framework/framework/MWSCoexistence/Source/MWS.d 


# Each subdirectory must supply rules for building sources it contributes
framework/framework/MWSCoexistence/Source/%.o: ../framework/framework/MWSCoexistence/Source/%.c
	@echo 'Building file: $<'
