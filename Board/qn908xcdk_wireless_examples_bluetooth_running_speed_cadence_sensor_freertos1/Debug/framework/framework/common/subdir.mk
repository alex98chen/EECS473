...
C_SRCS += \
../framework/framework/common/FwkInit.c 

OBJS += \
./framework/framework/common/FwkInit.o 

C_DEPS += \
./framework/framework/common/FwkInit.d 


# Each subdirectory must supply rules for building sources it contributes
framework/framework/common/%.o: ../framework/framework/common/%.c
	@echo 'Building file: $<'
