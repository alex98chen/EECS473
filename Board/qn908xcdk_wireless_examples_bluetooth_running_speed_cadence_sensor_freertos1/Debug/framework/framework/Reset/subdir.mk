...
C_SRCS += \
../framework/framework/Reset/Reset.c 

OBJS += \
./framework/framework/Reset/Reset.o 

C_DEPS += \
./framework/framework/Reset/Reset.d 


# Each subdirectory must supply rules for building sources it contributes
framework/framework/Reset/%.o: ../framework/framework/Reset/%.c
	@echo 'Building file: $<'
