...
C_SRCS += \
../framework/framework/GPIO/GPIO_Adapter.c 

OBJS += \
./framework/framework/GPIO/GPIO_Adapter.o 

C_DEPS += \
./framework/framework/GPIO/GPIO_Adapter.d 


# Each subdirectory must supply rules for building sources it contributes
framework/framework/GPIO/%.o: ../framework/framework/GPIO/%.c
	@echo 'Building file: $<'
