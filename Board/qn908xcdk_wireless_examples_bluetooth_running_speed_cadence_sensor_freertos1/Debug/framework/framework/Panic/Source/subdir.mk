...
C_SRCS += \
../framework/framework/Panic/Source/Panic.c 

OBJS += \
./framework/framework/Panic/Source/Panic.o 

C_DEPS += \
./framework/framework/Panic/Source/Panic.d 


# Each subdirectory must supply rules for building sources it contributes
framework/framework/Panic/Source/%.o: ../framework/framework/Panic/Source/%.c
	@echo 'Building file: $<'
