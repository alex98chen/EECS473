...
C_SRCS += \
../framework/framework/MemManager/Source/MemManager.c 

OBJS += \
./framework/framework/MemManager/Source/MemManager.o 

C_DEPS += \
./framework/framework/MemManager/Source/MemManager.d 


# Each subdirectory must supply rules for building sources it contributes
framework/framework/MemManager/Source/%.o: ../framework/framework/MemManager/Source/%.c
	@echo 'Building file: $<'
