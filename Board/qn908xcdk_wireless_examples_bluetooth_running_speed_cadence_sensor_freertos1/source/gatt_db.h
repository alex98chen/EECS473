...
PRIMARY_SERVICE(service_rsc, gBleSig_RunningSpeedAndCadenceService_d)
    ...
    CHARACTERISTIC(char_sensor_location, gBleSig_SensorLocation_d, (gGattCharPropRead_c))
        VALUE(value_sensor_location, gBleSig_SensorLocation_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 1, 0x00)
...
PRIMARY_SERVICE_UUID128(service_led, uuid_service_led)
	CHARACTERISTIC_UUID128(char_led_value, uuid_characteristic_led_value, (gGattCharPropRead_c | gGattCharPropWrite_c))
		VALUE_UUID128(value_led_value, uuid_characteristic_led_value, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 1, 0x00)

PRIMARY_SERVICE_UUID128(service_bcc, uuid_service_bcc)
	CHARACTERISTIC_UUID128(char_send_value, uuid_characteristic_send_value, (gGattCharPropRead_c | gGattCharPropWrite_c))
		VALUE_UUID128_VARLEN(value_send_value, uuid_characteristic_send_value, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 120, 1, 0x00)
	CHARACTERISTIC_UUID128(char_recvd_value,uuid_characteristic_recvd_value, (gGattCharPropRead_c))
		VALUE_UUID128_VARLEN(value_recvd_value, uuid_characteristic_recvd_value, (gPermissionFlagReadable_c), 136, 1, 0x00)
		CCCD(cccd_bcc_recvd)
