...
#else
/// Number of total TX spare buffers. Configure this macro in such a way that total TX data buffers do not exceed a value of 18.
#ifndef CFG_BLE_TX_SPARE_BUFF_CNT
#define CFG_BLE_TX_SPARE_BUFF_CNT    12
#endif
