 ...
 ************************************************************************************/
typedef union {
    void *                                              attGenericCallback;
    attIncomingServerErrorResponseCallback_t            attIncomingServerErrorResponseCallback;
    attIncomingServerExchangeMtuResponseCallback_t      attIncomingServerExchangeMtuResponseCallback;
    attIncomingServerFindInformationResponseCallback_t  attIncomingServerFindInformationResponseCallback;
    attIncomingServerFindByTypeValueResponseCallback_t  attIncomingServerFindByTypeValueResponseCallback;
    attIncomingServerReadByTypeResponseCallback_t       attIncomingServerReadByTypeResponseCallback;
    attIncomingServerReadResponseCallback_t             attIncomingServerReadResponseCallback;
    attIncomingServerReadBlobResponseCallback_t         attIncomingServerReadBlobResponseCallback;
    attIncomingServerReadMultipleResponseCallback_t     attIncomingServerReadMultipleResponseCallback;
    attIncomingServerReadByGroupTypeResponseCallback_t  attIncomingServerReadByGroupTypeResponseCallback;
    attIncomingServerWriteResponseCallback_t            attIncomingServerWriteResponseCallback;
    attIncomingServerPrepareWriteResponseCallback_t     attIncomingServerPrepareWriteResponseCallback;
    attIncomingServerExecuteWriteResponseCallback_t     attIncomingServerExecuteWriteResponseCallback;
    attIncomingServerHandleValueNotificationCallback_t  attIncomingServerHandleValueNotificationCallback;
    attIncomingServerHandleValueIndicationCallback_t    attIncomingServerHandleValueIndicationCallback;
    attIncomingClientExchangeMtuRequestCallback_t       attIncomingClientExchangeMtuRequestCallback;
    attIncomingClientFindInformationRequestCallback_t   attIncomingClientFindInformationRequestCallback;
    attIncomingClientFindByTypeValueRequestCallback_t   attIncomingClientFindByTypeValueRequestCallback;
    attIncomingClientReadByTypeRequestCallback_t        attIncomingClientReadByTypeRequestCallback;
    attIncomingClientReadRequestCallback_t              attIncomingClientReadRequestCallback;
    attIncomingClientReadBlobRequestCallback_t          attIncomingClientReadBlobRequestCallback;
    attIncomingClientReadMultipleRequestCallback_t      attIncomingClientReadMultipleRequestCallback;
    attIncomingClientReadByGroupTypeRequestCallback_t   attIncomingClientReadByGroupTypeRequestCallback;
    attIncomingClientWriteRequestCallback_t             attIncomingClientWriteRequestCallback;
    attIncomingClientWriteCommandCallback_t             attIncomingClientWriteCommandCallback;
    attIncomingClientSignedWriteCommandCallback_t       attIncomingClientSignedWriteCommandCallback;
    attIncomingClientPrepareWriteRequestCallback_t      attIncomingClientPrepareWriteRequestCallback;
    attIncomingClientExecuteWriteRequestCallback_t      attIncomingClientExecuteWriteRequestCallback;
    attIncomingClientHandleValueConfirmationCallback_t  attIncomingClientHandleValueConfirmationCallback;
} attIncomingCallbackType_t;
...
(
    attOpcode_t                      opcode,
    attIncomingCallbackType_t        callback
);
...
(
    deviceId_t                                deviceId,
    const attWriteRequestAndCommandParams_t*  pParams
);
