...
#define gActiveDevicesStorageSize_c      560
...
const uint8_t gGapMaxServiceSpecificSecurityRequirements = gcGapMaxServiceSpecificSecurityRequirements_c;
gapServiceSecurityRequirements_t gaServiceSecurityRequirements[gcGapMaxServiceSpecificSecurityRequirements_c];
