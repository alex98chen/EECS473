...
function BleCon(props) {
  return (
    <View style={styles.container}>
      <Text style={styles.loremIpsum}>
        Connect to BCC Device Bluetooth Low Energy
      </Text>
      <CupertinoButtonInfo onPress={props.bleScan} caption="Scan" style={styles.cupertinoButtonInfo} />
      ...
      <CupertinoButtonInfo
        onPress={props.bleCont}
        caption="Continue"
        style={styles.cupertinoButtonInfo2}
      />
      <CupertinoButtonInfo
        onPress={props.bleTest}
        caption="Test Ble"
